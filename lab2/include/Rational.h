...
public:
    ...
    template <typename R> Rational(const Rational<R>& rtal)
    {
        p = rtal.p;
        q = rtal.q;
        Reduce(p, q);
    ...
    template <typename R> Rational& operator=(const Rational<R> rhs)
    {
        p = rhs.p;
        q = rhs.q;
        Reduce(p, q);
    ...
    template <typename R> friend bool operator==(const Rational<R>& lhs, const Rational<T>& rhs)
    {
        return (lhs.p == rhs.p && lhs.q == rhs.q);
    }

    friend bool operator==(const Rational<T> lhs, const T& t) { return (lhs.p == t && lhs.q == 1); }

    friend bool operator==(const T& t, const Rational<T> rhs) { return (t == rhs.p && 1 == rhs.q); }
    ...
    template <typename R> Rational operator-(Rational<R>& rhs)
    {
